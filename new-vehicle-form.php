...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO Vehicles (VIN, CustomerID, registrationNum, year, Model, vehicleType, color)
            VALUES ('$vin','$cust','$plate','$year','$model','$make','$color')";

    if ($conn->query($sql) === TRUE) {
        echo "<h3 style='text-align:center; color:green'>Vehicle added successfully!</h3>";
    } else {
...
<body>
<h1 style="text-align: center; font-size: 50px;">Add New Vehicle</h1>

<form method="post" action="new-vehicle-form.php" style="text-align:center; font-size: 20px;">
